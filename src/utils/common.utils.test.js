...
describe('formatGiphyData', () => {
    ...
    it('should return an array of fomatted data', () => {
        const dataFromApi = [
            {
                images: {
                    fixed_width: {url: 'test1', height: 10, key: 1, title: ''},
                    fixed_width_still: {url: 'test1/still', height: 10, key: 2, title: ''}
                }
            },
            {
                images: {
                    fixed_width: {url: 'test2', height: 10, key: 3, title: ''},
                    fixed_width_still: {url: 'test2/still', height: 10, key: 4, title: ''}
                }
            }
        ];
        const expectedOutput = [
            {"data": [{"key": undefined, "moving": {"height": 10, "key": 1, "title": "", "url": "test1"}, "still": {"height": 10, "key": 2, "title": "", "url": "test1/still"}, "title": undefined}], "totalHeight": 10}, 
            {"data": [{"key": undefined, "moving": {"height": 10, "key": 3, "title": "", "url": "test2"}, "still": {"height": 10, "key": 4, "title": "", "url": "test2/still"}, "title": undefined}], "totalHeight": 10}
        ];
